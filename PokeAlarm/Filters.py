...
def load_egg_section(settings):
    ...
    egg = {
        ...
        "max_dist": float(settings.pop('max_dist', None) or float("inf")),
    }

    log.debug("Report eggs between level {} and {} and distance {} and {}".format(egg['min_level'], egg['max_level'], egg['min_dist'], egg['max_dist']))
